...
const PageFooter = () => {
    ...
    return (
        <div className="pgFooter">
            <Row>
                <Col className="p-1" md='4' onClick={() => window.location = 'mailto:pam@riverratmarineconstruction.com'}>
                    <img className='IconSmall p-2' alt='Email' src={emailImg}></img>
                    pam@riverratmarineconstruction.com
                </Col>
                <Col className="p-1" md='4' onClick={() => window.location = 'https://www.facebook.com/profile.php?id=100084151166191'}>
